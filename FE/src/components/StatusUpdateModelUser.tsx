...
interface StatusUpdateModalUserProps {
  isOpen: boolean;
...
const StatusUpdateModalUser: React.FC<StatusUpdateModalUserProps> = ({ isOpen, currentStatus, onClose, onUpdateStatus }) => {
...
export default StatusUpdateModalUser;
