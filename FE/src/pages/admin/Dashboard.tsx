                ...
                <tbody>
                    {products.map((product, index) => (
                        <tr key={product._id} className="text-center border-t border-gray-300">
                            ...
                            <td className="py-2 truncate max-w-xs">{product.categoryId?.name}</td>
                            <td className="py-2">
                                <button onClick={() => onDel(product._id!)} className="bg-red-500 text-white px-2 py-1 rounded mr-2">
                                    Delete
                                </button>
                                <Link to={`/admin/product/edit/${product._id}`} className="bg-yellow-500 text-white px-2 py-1 rounded">
                                    Edit
                                </Link>
                            </td>
                        </tr>
